...
const CreateableMultipleSelector = React.forwardRef<MultipleSelectorRef, MultipleSelectorProps>(
  (
    {
      value,
      onChange,
...
CreateableMultipleSelector.displayName = "MultipleSelector";
export default CreateableMultipleSelector;
